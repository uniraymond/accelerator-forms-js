...
},{"./core":14,"./mouse":16,"./widget":18,"jquery":19}],16:[function(require,module,exports){
var jQuery = require('jquery');
require('./widget');
...
},{"./widget":18,"jquery":19}],17:[function(require,module,exports){
var jQuery = require('jquery');
require('./core');
require('./mouse');
require('./widget');
...
},{"./core":14,"./mouse":16,"./widget":18,"jquery":19}],18:[function(require,module,exports){
var jQuery = require('jquery');
...
},{"knockout":22}],21:[function(require,module,exports){
...
},{"jquery":19,"jquery-ui/draggable":15,"jquery-ui/sortable":17,"knockout":22}],22:[function(require,module,exports){
/*!
...
},{"../templates/app.html":26,"../templates/checkbox-preview.html":27,"../templates/main-widget.html":28,"../templates/modal.html":29,"../templates/paragraph-preview.html":30,"../templates/radio-preview.html":31,"../templates/row-widget.html":32,"../templates/select-preview.html":33,"../templates/text-preview.html":34,"../templates/tr-field-info.html":35,"underscore":23}],25:[function(require,module,exports){
// jQuery
...
},{"./formBuilder":24,"bootstrap":1,"jquery":19,"jquery-ui/sortable":17,"knockout":22,"knockout-postbox":20,"knockout-sortable":21}],26:[function(require,module,exports){
module.exports = '<main-widget></main-widget>\n\n<modal></modal>';
},{}],27:[function(require,module,exports){
module.exports = '<input type="checkbox" data-bind="attr: { id: $parents[0].label.replace(\' \', \'_\').toLowerCase() }">';
},{}],28:[function(require,module,exports){
module.exports = '<main id="main">\n	<div class="container-fluid">\n		<div class="row">\n			<div class="col-md-6">\n				<div class="field-list">\n					<div class="row fields-header">\n						<div class="col-md-6">\n							<h3>Field List</h3>\n						</div>\n						<div class="col-md-6 add-new-field-wrapper text-right">\n							<button class="btn btn-primary btn-black open-create" data-bind="click: openAddFieldModal">\n								Add New Field\n							</button>\n						</div>\n					</div>\n					<div class="row">\n						<div class="col-md-12">\n							<table class="table table-striped">\n								<tr class="table-title">\n									<td>TYPE</td>\n									<td>LABEL</td>\n									<td>SIZE</td>\n									<td></td>\n								</tr>\n								<!-- ko component: { name: "tr-field-info" } -->\n								<!-- /ko -->\n							</table>\n						</div>\n					</div>\n				</div>\n			</div>\n			<div class="col-md-6">\n				<div class="field-preview">\n\n					<div class="row fields-header">\n						<div class="col-md-6">\n							<h3>Field Preview</h3>\n						</div>\n					</div>\n\n					<row-widget></row-widget>\n\n				</div>\n			</div>\n		</div>\n	</div>\n</main>';
},{}],29:[function(require,module,exports){
module.exports = '<div class="modal fade create" id="fieldModal">\n	<div class="modal-dialog">\n		<div class="modal-content">\n\n			<div class="modal-header">\n				<button type="button" class="close" data-dismiss="modal" aria-label="Close">\n					<span aria-hidden="true">&times;</span>\n				</button>\n				<h4 class="modal-title">Create New Field</h4>\n			</div>\n\n			<div class="modal-body">\n				<div class="form-group">\n					<label for="field-label">Field label</label>\n					<input class="form-control" name="field-label" id="field-label" type="text" placeholder="Hint text"\n						   data-bind="value: $parent.label, event:{change: $parent.save_label($parent.label) }">\n				</div>\n				<div class="form-group">\n					<label for="field-type">Field type</label>\n					<select class="form-control" name="field-type" id="field-type"\n							data-bind="value: $parent.type, event:{change: $parent.save_type($parent.type) }">\n						<option value="">Select one field type</option>\n						<option value="paragraph">Paragraph text</option>\n						<option value="select">Select</option>\n						<option value="checkbox">Checkbox</option>\n						<option value="radio">Radio</option>\n						<option value="text">Text Input</option>\n					</select>\n				</div>\n				<div class="form-group">\n					<label for="field-size">Field size</label>\n					<select class="form-control" id="field-size" name="field-size"\n							data-bind="value: $parent.size, event:{change: $parent.save_size($parent.size) }">\n						<option value="">Select a size for this field</option>\n						<option value="large">Large</option>\n						<option value="medium">Medium</option>\n						<option value="small">Small</option>\n					</select>\n				</div>\n			</div>\n\n			<div class="modal-footer">\n				<button type="button" class="btn btn-default create"\n						data-bind="click: $parent.create_field($parent.label, $parent.type, $parent.size)">\n					Add field\n				</button>\n				<button type="button" class="btn btn-default edit"\n						data-bind="click: $parent.create_field($parent.label, $parent.type, $parent.size)">\n					Edit field\n				</button>\n			</div>\n\n		</div>\n	</div>\n</div>';
},{}],30:[function(require,module,exports){
module.exports = '<!--<p data-bind="css: { id: $parents[0].type }, text: $parents[0].label"></p>-->';
},{}],31:[function(require,module,exports){
module.exports = '<input type="radio" data-bind="attr: { id: $parents[0].label.replace(\' \', \'_\').toLowerCase() }">';
},{}],32:[function(require,module,exports){
module.exports = '<div class="form-group"\n	 data-bind="sortable: { data: $parents[1].rows, options: { placeholder: \'sortable-placeholder\', axis: \'y\' } }">\n\n	<div class="form-group sortable" data-bind="css: size, css: type+\'-field\'">\n		<label data-bind="text: label, attr: { for: label.replace(\' \', \'_\').toLowerCase() }"></label>\n\n		<!-- ko component: { name: type + \'-preview\' } -->\n		<!-- /ko -->\n\n	</div>\n\n</div>';
},{}],33:[function(require,module,exports){
module.exports = '<select class="form-control" data-bind="attr: { id: $parents[0].label.replace(\' \', \'_\').toLowerCase() }">\n	<option value="">Select...</option>\n</select>';
},{}],34:[function(require,module,exports){
module.exports = '<input type="text" class="form-control" data-bind="attr: { placeholder: $parents[0].label, id: $parents[0].label.replace(\' \', \'_\').toLowerCase() }">';
},{}],35:[function(require,module,exports){
module.exports = '<!-- ko foreach: $parents[1].rows -->\n<tr class="table-field-item">\n	<td data-bind="text: type"></td>\n	<td data-bind="text: label"></td>\n	<td data-bind="text: size"></td>\n	<td class="edit-delete">\n		<span class="open-edit">Edit</span>\n		<span class="delete" data-bind="click: function() { $parents[2].remove_field($parents[2].rows()[$index()]); }">Delete</span>\n	</td>\n</tr>\n<!-- /ko -->';
},{}]},{},[25])
